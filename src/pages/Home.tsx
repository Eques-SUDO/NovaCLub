...
const Home: React.FC = () => {
  ...
  const staffMembers = useMemo<StaffMember[]>(() => [
    ...
    },
    {
      ...
      colorScheme: {
        primary: "text-gradient-pink-orange",
  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-dark-bg pt-24 md:pt-0">
        <div 
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          {/* Enhanced Floating Musical Notes with Glow */}
          <div className="absolute top-20 left-10 text-nova-neon/30 text-2xl animate-bounce" style={{ 
            animationDelay: '1s', 
            animationDuration: '3s',
            filter: 'drop-shadow(0 0 8px rgba(168, 85, 247, 0.4))'
          }}>♪</div>
          <div className="absolute top-32 right-16 text-primary/25 text-xl animate-bounce" style={{ 
            animationDelay: '2s', 
            animationDuration: '4s',
            filter: 'drop-shadow(0 0 6px rgba(155, 77, 224, 0.4))'
          }}>♫</div>
          <div className="absolute bottom-40 left-20 text-nova-neon/20 text-3xl animate-bounce" style={{ 
            animationDelay: '0.5s', 
            animationDuration: '5s',
            filter: 'drop-shadow(0 0 10px rgba(168, 85, 247, 0.3))'
          }}>♬</div>
          <div className="absolute bottom-64 right-24 text-primary/20 text-lg animate-bounce" style={{ 
            animationDelay: '3s', 
            animationDuration: '3.5s',
            filter: 'drop-shadow(0 0 5px rgba(155, 77, 224, 0.3))'
          }}>♩</div>
          <div className="absolute top-1/3 left-1/4 text-nova-neon/15 text-4xl animate-bounce" style={{ 
            animationDelay: '1.5s', 
            animationDuration: '6s',
            filter: 'drop-shadow(0 0 12px rgba(168, 85, 247, 0.2))'
          }}>♭</div>
          <div className="absolute top-2/3 right-1/3 text-primary/15 text-2xl animate-bounce" style={{ 
            animationDelay: '2.5s', 
        ...
        <div className="relative z-10 text-center max-w-6xl px-8">
          <div className="mb-8">
            <div className="flex items-center justify-center gap-2 mb-8 opacity-80">
              ...
              <span className="text-gradient-aurora text-sm font-medium tracking-widest uppercase">ETERNOTES Music Club</span>
              <FaMusic className="text-nova-neon text-lg" />
            ...
            <div className="relative">
              ...
              <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-black font-display mb-8 md:mb-12 leading-tight opacity-0 animate-fadeIn relative">
                ...
                <span className="block text-brand bg-clip-text text-transparent mt-2">COMES ALIVE</span>
              </h1>
            </div>
          </div>
