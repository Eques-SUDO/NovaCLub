      ...
      <div className="container-custom relative z-10">
        ...
        <div className="text-center mb-12 md:mb-20 px-4">
          <div className="inline-flex items-center gap-2 md:gap-3 mb-6 px-4 md:px-6 py-2 md:py-3 glass rounded-full border border-primary/20">
            ...
            <span className="text-gradient-aurora font-medium text-sm md:text-base">ETERNOTES Music Club</span>
          </div>
          
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold font-display text-gradient-cosmic mb-4 md:mb-6 leading-tight">
            Our Musicians
          </h1>
          <p className="text-lg md:text-xl lg:text-2xl text-gradient-blue-cyan max-w-3xl mx-auto leading-relaxed font-medium">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 px-4">
            {currentArtists.map((artist, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold font-heading mb-2 text-gradient-purple-pink group-hover:text-gradient-neon transition-all duration-300">
                  {artist.name}
                </h3>
